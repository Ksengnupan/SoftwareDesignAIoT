...
## Payment and Invoice
The payment and invoice are done by the **QR code**. The customer can **scan the QR code** to pay the bill. The **QR code** is generated by the **M5Stack Core2**. Once the QR code is scanned, the orders from the **open order collection** will be fetched for display of invoice and the **payment** will be **completed**. Before the final display of the invoice, the user will be given an option to **enter the coupon code** for eligible promotion. The total cost will be updated accordingly. The **invoice** will then be **generated** and **sent to the customer**. The server will **delete the record** from open order collection by the table number. The **invoice** will be **stored** in the **order collection**. Finally, the user can download the invoice in **PDF** format.